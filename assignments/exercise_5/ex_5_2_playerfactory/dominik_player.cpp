...
player *dominik_player::make(const std::string &plr, int player_id) {
	if (plr != "dominik") {
		return nullptr;
	}
	return new dominik_player(player_id);
}

static player_factory_helper<dominik_player> registerDominikPlayer;